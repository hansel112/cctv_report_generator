...
"""The CCTV Report Generator System.
...
# Creating table for logging events
...
known_face_names = []      # Corresponding face names will be added here
...
# Main Execution
rtsp_url = "rtsp://<camera_url>"  # The RTSP URL for the camera eg; rtsp://username:password@IP_ADDRESS:PORT/stream1
...
try:
    while True:
        ...
        # Weekly report and email logic
        current_day = datetime.datetime.now().weekday()
        current_time = datetime.datetime.now().strftime('%H:%M')
        
        # Assuming sending the report on Sunday at 18:00
        if current_day == 6 and current_time == '18:00':
